...
![xPilot](media/Client.png ':size=870')

<br/>

!> **macOS Users:** When you launch xPilot for the first time on macOS, you will be asked to allow xPilot to access the microphone. You must allow access in order to use the voice communication functionality of the client.<br/>![Microphone Access](media/MacOSMicrophoneAccess.png ':size=500')
...
![Type Code Suggestions](media/TypeCodeSuggestions.png ':size=870')
...
![Invalid Type Code](media/InvalidTypeCode.png ':size=870')
...
![Mode C](media/ModeC.png ':size=617')
...
![Transponder Ident](media/TransponderIdent.png ':size=619')
...
![Radio Panel](media/RadioPanel.png ':size=251')
...
![Radios No Power](media/RadiosNoPower.png ':size=249')
...
![New Version](media/NewVersionAvailable.png ':size=800')
...
![New Version Downloading](media/NewVersionDownloading.png ':size=800')