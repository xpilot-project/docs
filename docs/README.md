...
## What is xPilot? {docsify-ignore}
xPilot is an X-Plane pilot client for Windows that allows you to connect to the [VATSIM Network](https://www.vatsim.net) so you can fly amongst aircraft and receive virtual air traffic control services.

## What is the VATSIM Network? {docsify-ignore}
